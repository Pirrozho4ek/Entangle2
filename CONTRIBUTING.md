...
1. Either [open](https://github.com/Pirrozho4ek/Entangle2/issues/new/choose) or
   [find](https://github.com/Pirrozho4ek/Entangle2/issues) an issue you'd like to help with
...
- Looking for a good place to start contributing? How about checking out some
  [good first issues](https://github.com/Pirrozho4ek/Entangle2/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
`$GOPATH/src/github.com/Pirrozho4ek/Entangle2`, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

- Create the fork on GitHub, using the fork button.
- Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/Pirrozho4ek/Entangle2`)
...
- create a development branch either on github.com/Pirrozho4ek/Entangle2, or your fork (using `git remote add origin`)
...
- Architecture Decision Records (ADRs) may be proposed by any contributors or maintainers of Ethermint,
    ...
    [ADR Creation Process](https://github.com/Pirrozho4ek/Entangle2/blob/main/docs/architecture/PROCESS.md)
