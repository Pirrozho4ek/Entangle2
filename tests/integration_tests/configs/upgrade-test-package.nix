let
  pkgs = import ../../../nix { };
  fetchEthermint = rev: builtins.fetchTarball "https://github.com/Pirrozho4ek/Entangle2/archive/${rev}.tar.gz";
  released = pkgs.buildGo118Module rec {
    name = "ethermintd";
    # the commit before https://github.com/Pirrozho4ek/Entangle2/pull/943
